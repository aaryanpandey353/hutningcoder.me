...
<head>
    ...
    <title>Sign Up | CodeWithAaryan</title>
    ...
    <div id="__next">
        ...
        <div class="w-full z-10 sticky bg-white top-0 border-b border-grey-light shadow-md">
            <div class="w-full flex flex-wrap items-center lg:justify-between mt-0 py-4">
                ...
                </div><a href="/sign/login.phplogin"><button
                ...
                <div class="w-full flex-grow lg:flex lg:flex-1 lg:content-center lg:justify-end lg:w-auto h-0 lg:h-auto overflow-hidden mt-2 lg:mt-0 z-20 transition-all"
                    ...
                    <div class="text-center my-2 px-4"><a href="http://localhost/hutningcoder.me/login.php"><button
            ...
            <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div class="w-full p-8 lg:w-1/2"><img class="mx-auto rounded object-cover h-16"
                    ...
                    <div class="mt-4 flex items-center justify-between"><span
                            ...
                            class="text-xs text-center text-gray-500 uppercase">OR SIGN UP WITH EMAIL </span><span
                            class="border-b w-1/5 lg:w-1/4"></span></div>
                    <form action="" method="post">

                        <div class="mt-4"><label class="block text-gray-700 text-sm font-bold mb-2">Email
                                Address</label><input name="username" type="email" required id="inputEmail4"
                                class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                                type="email" /></div>
                        <div class="mt-4"><label class="block text-gray-700 text-sm font-bold mb-2">Password</label>
                            <input name="password" required id="inputPassword4"
                                class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                                type="password" />

                                <label class="block text-gray-700 text-sm font-bold mb-2">Comfrim Password</label>
                            <input name="confirm_password" required id="inputPassword"
                                class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                                type="password" />
                    ...
                    <button id="myButton" class="bg-gray-700 text-white mt-8 font-bold py-2 px-4 w-full rounded hover:bg-gray-600 disabled:opacity-50" type="submit" class="btn btn-primary">Sign Up</button>
                </form>
                    <div class="mt-4 flex items-center justify-between"><span
                            class="border-b w-1/5 md:w-1/4"></span><span class="text-xs text-gray-500 uppercase"><a
                                href=""> or Login</a></span><span
