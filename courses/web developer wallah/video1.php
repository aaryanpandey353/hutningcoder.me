                ...
                <div class="mx-auto w-full xl:text-lg font-medium pt-3 px-2 rounded-t-lg lg:w-1/3 overflow-x-hidden">
                    ...
                    <div
                        ...
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <a href="/hutningcoder.me/courses/web developer wallah/index.php"><div class="mt-4 cursor-pointer">Introduction to HTML, CSS, JavaScript & How websites work? | Web Development Tutorials #1</div></a>
                        </div>
                        <a href="/hutningcoder.me/courses/web developer wallah/video1.php"><div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
            ...
            <div class="flex mx-4 lg:mr-16 my-3 px-3 justify-between lg:w-2/3"><a href="/courses/web developer wallah/index.html"></a><button
