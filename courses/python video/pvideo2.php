...
<body>
    <div id="__next">
                ...
                <div class="mx-auto w-full xl:text-lg font-medium pt-3 px-2 rounded-t-lg lg:w-1/3 overflow-x-hidden">
                    ...
                    <div
                        ...
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                            name="" id="" class="mr-2" />
                           <a href="/hutningcoder.me/courses/python video/index.php"> <div class="mt-4 cursor-pointer">Downloading Python and Pycharm Installation</div>
                        </div></a>
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <a href="/hutningcoder.me/courses/python video/pvideo1.php"><div class="mt-4 cursor-pointer">Using Modules & Pip In Python | Python Tutorials For Absolute Beginners In Hindi #2</div></a>
                        </div>
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <a href="/hutningcoder.me/courses/python video/pvideo2.php"><div class="mt-4 cursor-pointer">Writing Our First Python Program | Python Tutorials For Absolute Beginners In Hindi #3</div></a>
                        </div>
        ...
        <div id="panels">
            ...
            <div class="flex mx-4 lg:mr-16 my-3 px-3 justify-between lg:w-2/3"><a href="/hutningcoder.me/courses/python video/pvideo1.php"><button
