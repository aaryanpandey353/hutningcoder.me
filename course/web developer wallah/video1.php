...
<link rel="preload" href="https://huntingcoder.me/css/c2a8c86eebdcf29d.css" as="style" />
    ...
    <title>
HTML Tutorial: Installing VS Code & Live Server | Web Development Tutorials #2</title>
</head>
            ...
            <div class="flex flex-wrap lg:-mx-1 xl:-mx-1">
                <div class="w-full border lg:my-1 lg:px-1 lg:w-2/3 xl:my-1 xl:px-1 xl:w-2/3 mx-auto">
                    <div class="h-[30vh] lg:h-[30vh] mx-auto xl:h-[70vh]"><iframe title="YouTube Video"
                            src="https://www.youtube.com/embed/vhL6UOTcaGE" frameBorder="0"
                ...
                <div class="mx-auto w-full xl:text-lg font-medium pt-3 px-2 rounded-t-lg lg:w-1/3 overflow-x-hidden">
                    ...
                    <div
                        ...
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <a href="/hutningcoder.me/course/web developer wallah/index.php"><div class="mt-4 cursor-pointer">Introduction to HTML, CSS, JavaScript & How websites work? | Web Development Tutorials #1</div></a>
                        </div>
                        <a href="/hutningcoder.me/course/web developer wallah/video1.php"><div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <div class="mt-4 cursor-pointer">HTML Tutorial: Installing VS Code &amp; Live Server | Web
                                Development Tutorials #2</div>
                        </div></a>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
            ...
            <div class="flex mx-4 lg:mr-16 my-3 px-3 justify-between lg:w-2/3"><a href="/course/web developer wallah/index.html"></a><button
                    ...
                    disabled=""> Previous </button></a><button
                        class="text-white w-20 cursor-pointer justify-center bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center mx-1 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-default">
                        Next </button></a></div>
        </div>
