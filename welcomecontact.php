...
<head>
    ...
    <link rel="stylesheet" href="https://huntingcoder.me/css/ef46db3751d8e999.css" data-n-p="" /><noscript
        data-n-css=""></noscript>
                ...
                <div class="flex flex-col justify-center items-center">
                    <div>
                        <h2 class="text-center text-3xl font-bold leading-tight">Feel free to contact us!</h2><img
                            class="h-40 my-5 mx-auto py-2" src="https://huntingcoder.me/img/logo-blue.png" />
                    </div>
                </div>
